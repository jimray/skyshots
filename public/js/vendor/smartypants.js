/**
 * smartypants.js 0.2.2 -- https://github.com/othree/smartypants.js
 * Copyright (c) 2016, othree. BSD-3-Clause; see smartypants.LICENSE.
 *
 * Vendored rather than installed: this app has no build step and no
 * dependencies, and serves its modules to the browser as they are. To update,
 * `npm pack smartypants`, copy `smartypants.mjs` here and copy its LICENSE
 * beside it. Do not edit this file -- `../smart-quotes.js` wraps it, and the
 * two quirks that wrapper works around are documented there.
 */
